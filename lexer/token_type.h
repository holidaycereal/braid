...
typedef enum {
	// Keywords
	WORD_IF, WORD_THEN, WORD_ELSE, WORD_WHILE, WORD_FOR, WORD_IN, WORD_BREAK,
	WORD_CONTINUE, WORD_MATCH, WORD_DYN, WORD_DATA, WORD_TYPE, WORD_INCLUDE,
	WORD_IMPORT, WORD_EXIT,
	...
	STAR_EQUALS, SLASH_EQUALS, CARET_EQUALS, PERCENT_EQUALS,
	RANGE,                      //  ..
	MODULE,                     //  ::
